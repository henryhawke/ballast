...
const Tools = ({ intl }) => {
  ...
  */
  ...
  const showResults = (result) => {
    ...
    if (values.ballastMaterial === "1") {
      ballastMaterial = "Plastic Barrel";
    } else if (values.ballastMaterial === "2") {
      ballastMaterial = "Steel Drum";
    } else if (values.ballastMaterial === "3") {
      ballastMaterial = "Concrete Block";
    }

    console.log("ballastMaterial: " + ballastMaterial);
  ...
  const handleBallastMaterialSelectChange = (event) => {
    ...
    if (name === "ballastMaterial") {
      ...
      console.log(values.ballastMaterial);
    }
  };
