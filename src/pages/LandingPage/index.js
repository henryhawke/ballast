    ...
    <ThemeProvider theme={theme}>
      <React.Fragment>
        ...
        <Helmet>
          ...
          <link rel='canonical' href='https://ballast.web.app/' />
          <meta
            name='keywords'
            content={"tent,wind,tool,ifai,clemson,event,ballast,calculate"}
          />
          <meta
            name='description'
            content={"Tent Overturn Resistance Tool - IFAI "}
          />

          <title>Ballast Tool</title>
        </Helmet>
        <Scrollbars
          ref={(e) => {
            if (e !== null) {
